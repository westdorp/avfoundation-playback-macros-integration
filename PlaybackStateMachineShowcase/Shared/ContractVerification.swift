...
///
/// These functions are invoked once during startup so the verifier code is
/// retained in optimized builds and type signatures remain stable across
/// module boundaries.
...
/// Forces contract-verification references to remain in the final binary.
///
/// This prevents dead stripping from removing compile-time integration checks
/// in optimized builds.
private let forceContractVerification: Void = {
    ContractVerification.verifyStateMachineTypes()
